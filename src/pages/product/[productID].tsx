    ...
    return (
        <div className="">
            <div className="pt-6">
                ...
                <div className="my-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8">
                    <Fade left>
                ...
                <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:pt-16 lg:pb-24 lg:px-8 lg:grid lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8">
                    ...
                    <div className="mt-4 lg:mt-0 lg:row-span-3 ">
                        ...
                        <VariantPicker
                            ...
                            disabled={oneStyle}
                        />
                        <h1 className='font-oxanium-extrabold py-2 text-sunset-pink '>FREE SHIPPING!</h1>
                        <button
                        className="snipcart-add-item w-full mb-20 bg-nightsky/5 border-2 transition-all border-sunset-pink rounded-md py-3 px-8 flex items-center justify-center text-base font-oxanium-semibold text-cloudy-day hover:bg-sunset-pink focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sunset-orange"
