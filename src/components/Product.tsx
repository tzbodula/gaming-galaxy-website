...
const Product = (product) => {
  ...
  return (
    <article className="product-card rounded bg-white flex flex-col relative">
      <button
      ...
      >
        {onWishlist ? (
          <svg
            ...
            viewBox="0 0 24 24"
            className="w-6 h-6 fill-current text-sunset-pink"
          >
      ...
      <div className="flex items-center  justify-center flex-1 sm:flex-shrink-0 w-full pt-6 pl-6 pr-6 ">
        <div className="bg-cloudy-day/5 border-2 border-sunset-pink shadow-lg shadow-sunset-pink/50">
        {activeVariantFile && (
          <Image
      ...
      <div className="flex-1 p-6 mt-4 pt-0">
        <div className="text-center">
          <p className="mb-1 font-oxanium-semibold text-cloudy-day">{name}</p>
          <p className="text-sm font-oxanium-medium text-cloudy-day mb-1">{formattedPrice}</p>
          <div className="font-oxanium-bold">
          <Link href={`/product/${encodeURIComponent(product.id)}`}>More Details</Link>
          </div>
      ...
      <div className="p-3 flex flex-col sm:flex-row justify-center items-center">
        ...
        />
        <button
          className="snipcart-add-item w-full md:w-auto transition flex-shrink-0 py-2 px-4 border border-sunset-pink hover:border-transparent shadow-sm text-sm font-medium bg-midnight-blue font-oxanium-semibold text-cloudy-day focus:text-white hover:bg-blue-600 hover:text-white focus:bg-blue-600 focus:outline-none rounded"
