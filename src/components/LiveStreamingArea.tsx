      ...
      <div className="row grid grid-rows-1 grid-cols-2">
        <div className="">
          <div className="live-stream-item ">
            ...
            <div className="content mt-32 mr-2">
              <div className="live-stream-meta">
                <ul>
                  <li className="cat"><Link href="/#" passHref>YOUTUBE</Link></li>
                  <li>3 months ago</li>
                </ul>
              </div>
              <h4 className="title font-oxanium-semibold"><Link href="/#" passHref>The secret underground YouTube growth method</Link></h4>
            </div>
          </div>
        </div>
        <div className="">
          <div className="row ml-20">
            <div className="col-lg-12 col-md-6">
              <div className="live-stream-item style-two mb-3">
                <div className="thumb popup-video">
